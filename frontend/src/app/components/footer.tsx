      ...
      <div className="container">
        <div className={styles.footerGrid}>
          <div className={styles.footerBrand}>
            <div className={styles.footerLogo}>
              <div className={styles.logoIcon}>
                <Image
                  src="/images/logo isctem.png" // caminho para seu logo na pasta public
                  alt="PhytoMoz Logo"
                  width={110}
                  height={55}
                />
          ...
          <div className={styles.footerLinks}>
            <h3 className={styles.footerHeading}>Links Rápidos</h3>
            <ul className={styles.linksList}>
              ...
              <li>
                <Link href="/referencias" className={styles.footerLink}>
                  Referências
                </Link>
              </li>
            </ul>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>©{new Date().getFullYear()} Desenvolvido por: Elcar Macuácua, com supervisão de Msc. Otília Graça, e com colaboração do Curso de Farmácia e Controle de Qualidade de Medicamentos.</p>
        </div>
      </div>
    </footer>
  )
